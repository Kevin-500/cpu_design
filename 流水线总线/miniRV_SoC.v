`timescale 1ns / 1ps
module miniRV_SoC #(parameter MEM_INIT_FILE="src/coe/pipeline_soc_selftest.mem", parameter integer MEM_INIT_WORDS=12) (input wire fpga_clk,input wire fpga_rst,input wire [15:0] sw,output wire [15:0] led,output wire [7:0] dig_en,output wire [7:0] dig_seg,output wire [7:0] dig_seg1,input wire rx,output wire tx);
`ifdef RUN_TRACE
